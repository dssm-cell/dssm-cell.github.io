document.addEventListener("DOMContentLoaded", () => {
  ...
  adoptionForm.addEventListener("submit", (event) => {
    ...
    if (!isValidName(nome)) {
      document.getElementById("erroNomeAdocao").textContent = "Digite um nome válido.";
      valid = false;
    }

    if (!isValidEmail(email)) {
      document.getElementById("erroEmailAdocao").textContent = "Digite um e-mail válido.";
      valid = false;
    }

    if (!isValidPhone(telefone)) {
      document.getElementById("erroTelefoneAdocao").textContent = "Digite um telefone válido.";
      valid = false;
    }

    if (!pet) {
      document.getElementById("erroPetEscolhido").textContent = "Selecione um pet.";
      valid = false;
    }
    ...
    adoptionForm.reset();
    setMessage(msg, "Cadastro enviado com sucesso! Sua solicitação foi salva.", true);
  ...
  suggestionForm.addEventListener("submit", (event) => {
    ...
    if (!isValidName(nome)) {
      document.getElementById("erroNomeSugestao").textContent = "Digite um nome válido.";
      valid = false;
    }

    if (!isValidEmail(email)) {
      document.getElementById("erroEmailSugestao").textContent = "Digite um e-mail válido.";
      valid = false;
    }
  ...
  contactForm.addEventListener("submit", (event) => {
    ...
    if (!isValidName(nome)) {
      document.getElementById("erroNomeContato").textContent = "Digite um nome válido.";
      valid = false;
    }

    if (!assunto) {
      document.getElementById("erroAssuntoContato").textContent = "Selecione um assunto.";
      valid = false;
    }
